...

{
  home.packages = [
    pkgs.git
    (pkgs.writeShellScriptBin "nixos-setup-dotfiles" ''
      #!/bin/bash
      ...
      declare -A TARGET_DIRS=(
        ["git@github-personal:itsfabijano/config.nvim.git"]="$HOME/config.nvim"
        ["git@github-personal:itsfabijano/nixos-config.git"]="$HOME/nixos-config"
      )
